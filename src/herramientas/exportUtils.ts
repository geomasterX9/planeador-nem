        ...
        if (evaluationData.herramientas.includes('Guías de observación') && (evaluationData.observacion || []).length > 0) {
            ...
            const obsRows = [
                new TableRow({
                    ...
                    children: [
                        new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold("No.", 14, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 40, type: WidthType.PERCENTAGE }, children: [pBold("INDICADORES OBSERVABLES", 14, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold("SIEMPRE", 12, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold("A VECES", 12, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold("NUNCA", 12, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 20, type: WidthType.PERCENTAGE }, children: [pBold("OBSERVACIONES", 12, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } })
                    ]
                })
            ];
            evaluationData.observacion.forEach((criterio: string, i: number) => {
                obsRows.push(new TableRow({ children: [ 
                    new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold((i + 1).toString(), 16, AlignmentType.CENTER)] }), 
                    new TableCell({ width: { size: 40, type: WidthType.PERCENTAGE }, children: [pReg(criterio, 16, AlignmentType.LEFT)] }), 
                    new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pReg(" ", 16)] }), 
                    new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pReg(" ", 16)] }), 
                    new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pReg(" ", 16)] }), 
                    new TableCell({ width: { size: 20, type: WidthType.PERCENTAGE }, children: [new Paragraph({ children: [new TextRun({ text: " " })], spacing: { before: 200, after: 200 } })] }) 
                ] }));
            });
            docChildren.push(new Table({ width: { size: 100, type: WidthType.PERCENTAGE }, layout: TableLayoutType.FIXED, columnWidths: [1444, 5776, 1444, 1444, 1444, 2888], rows: obsRows }));
        }
        ...
        if (evaluationData.herramientas.includes('Escalas estimativas') && (evaluationData.escala || []).length > 0) {
            ...
            const escalaRows = [
                new TableRow({
                    ...
                    children: [
                        new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold("No.", 14, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 42, type: WidthType.PERCENTAGE }, children: [pBold("INDICADORES", 14, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pBold("SOBRESALIENTE", 10, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pBold("SATISFACTORIO", 10, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pBold("BÁSICO", 10, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } }),
                        new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pBold("REQUIERE APOYO", 10, AlignmentType.CENTER, colorHeaderTxt)], shading: { fill: colorHeaderBg } })
                    ]
                })
            ];
            evaluationData.escala.forEach((criterio: string, i: number) => {
                escalaRows.push(new TableRow({ children: [ 
                    new TableCell({ width: { size: 10, type: WidthType.PERCENTAGE }, children: [pBold((i + 1).toString(), 16, AlignmentType.CENTER)] }),
                    new TableCell({ width: { size: 42, type: WidthType.PERCENTAGE }, children: [pReg(criterio, 16, AlignmentType.LEFT)] }), 
                    new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pReg(" ")] }), 
                    new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pReg(" ")] }), 
                    new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pReg(" ")] }), 
                    new TableCell({ width: { size: 12, type: WidthType.PERCENTAGE }, children: [pReg(" ")] }) 
                ] }));
            });
            docChildren.push(new Table({ width: { size: 100, type: WidthType.PERCENTAGE }, layout: TableLayoutType.FIXED, columnWidths: [1444, 6064, 1733, 1733, 1733, 1733], rows: escalaRows }));
        }
